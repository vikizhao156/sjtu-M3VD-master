...
def get_dataset():
    ...
    for i in range(len(x_filef_train)):
        ...
        x_temp=np.fft.fft(x_voxel*x_mask*0.8+x_voxel*0.2)
...
model.fit(x_train, x_train_label,batch_size=16, epochs=150,validation_split=0.20, verbose=2, shuffle=False, callbacks=[early_stopping])
